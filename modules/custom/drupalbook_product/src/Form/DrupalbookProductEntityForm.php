 ...
 */
class DrupalbookProductEntityForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('entity.drupalbook_product_entity.canonical', ['drupalbook_product_entity' => $entity->id()]);
  }
